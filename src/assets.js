...
export const ASSET_CACHE_VERSION = 'shell-vivid-20260904-v29';
...
export const CRITICAL_STARTUP_ASSET_KEYS = Object.freeze([
  ...
  'effect-projectile-berry-v1',
  'effect-projectile-dew-v1',
  'effect-projectile-bell-v1',
  'effect-projectile-drill-v1',
  'effect-projectile-ember-v1',
  'effect-projectile-ink-v1',
  'effect-projectile-cloud-v1',
  'effect-projectile-frost-v1',
  'effect-projectile-honey-v1',
  'effect-projectile-spark-v1',
...
const DECLARED_ASSET_PATHS = {
  ...
  'survivor-berry-burst': generatedAssetUrl('survivor/survivor-berry-burst.png'),
  'hero-berry-burst-atlas-v1': generatedAssetUrl('hero/hero-berry-burst-atlas-v1.png'),
  'survivor-dew-bloom': generatedAssetUrl('survivor/survivor-dew-bloom.png'),
  'hero-dew-bloom-atlas-v1': generatedAssetUrl('hero/hero-dew-bloom-atlas-v1.png'),
  'hero-bell-boom-atlas-v1': generatedAssetUrl('hero/hero-bell-boom-atlas-v1.png'),
  'hero-drill-gum-atlas-v1': generatedAssetUrl('hero/hero-drill-gum-atlas-v1.png'),
  'hero-ember-fizz-atlas-v1': generatedAssetUrl('hero/hero-ember-fizz-atlas-v1.png'),
  'hero-ink-splash-atlas-v1': generatedAssetUrl('hero/hero-ink-splash-atlas-v1.png'),
  'hero-cloud-spin-atlas-v1': generatedAssetUrl('hero/hero-cloud-spin-atlas-v1.png'),
  'hero-frost-drop-atlas-v1': generatedAssetUrl('hero/hero-frost-drop-atlas-v1.png'),
  'hero-honey-pop-atlas-v1': generatedAssetUrl('hero/hero-honey-pop-atlas-v1.png'),
  'hero-spark-bean-atlas-v1': generatedAssetUrl('hero/hero-spark-bean-atlas-v1.png'),
  'hero-star-core-atlas-v1': generatedAssetUrl('hero/hero-star-core-atlas-v1.png'),
  'hero-berry-burst-skill-face-v1': generatedAssetUrl('hero/hero-berry-burst-skill-face-v1.png'),
  'hero-dew-bloom-skill-face-v1': generatedAssetUrl('hero/hero-dew-bloom-skill-face-v1.png'),
  'hero-bell-boom-skill-face-v1': generatedAssetUrl('hero/hero-bell-boom-skill-face-v1.png'),
  'hero-drill-gum-skill-face-v1': generatedAssetUrl('hero/hero-drill-gum-skill-face-v1.png'),
  'hero-ember-fizz-skill-face-v1': generatedAssetUrl('hero/hero-ember-fizz-skill-face-v1.png'),
  'hero-ink-splash-skill-face-v1': generatedAssetUrl('hero/hero-ink-splash-skill-face-v1.png'),
  'hero-cloud-spin-skill-face-v1': generatedAssetUrl('hero/hero-cloud-spin-skill-face-v1.png'),
  'hero-frost-drop-skill-face-v1': generatedAssetUrl('hero/hero-frost-drop-skill-face-v1.png'),
  'hero-honey-pop-skill-face-v1': generatedAssetUrl('hero/hero-honey-pop-skill-face-v1.png'),
  'hero-spark-bean-skill-face-v1': generatedAssetUrl('hero/hero-spark-bean-skill-face-v1.png'),
  'hero-star-core-skill-face-v1': generatedAssetUrl('hero/hero-star-core-skill-face-v1.png'),
  ...
  'soldier-bounce-hammer-atlas-v1': generatedAssetUrl('soldier/soldier-bounce-hammer-atlas-v1.png'),
  'soldier-leaf-spinner-atlas-v1': generatedAssetUrl('soldier/soldier-leaf-spinner-atlas-v1.png'),
  'soldier-drill-lancer-atlas-v1': generatedAssetUrl('soldier/soldier-drill-lancer-atlas-v1.png'),
  'soldier-spore-lobber-atlas-v1': generatedAssetUrl('soldier/soldier-spore-lobber-atlas-v1.png'),
  'soldier-volt-orbiter-atlas-v1': generatedAssetUrl('soldier/soldier-volt-orbiter-atlas-v1.png'),
  ...
  'enemy-thorn-roller-atlas-v1': generatedAssetUrl('enemy/enemy-thorn-roller-atlas-v1.png'),
  'enemy-lantern-spore-atlas-v1': generatedAssetUrl('enemy/enemy-lantern-spore-atlas-v1.png'),
  'enemy-mud-bulwark-atlas-v1': generatedAssetUrl('enemy/enemy-mud-bulwark-atlas-v1.png'),
  'enemy-rift-beacon-king-atlas-v1': generatedAssetUrl('enemy/enemy-rift-beacon-king-atlas-v1.png'),
  ...
  'turret-bubble-coil': generatedAssetUrl('turret/turret-bubble-coil-v1.png'),
  'turret-crystal-repeater': generatedAssetUrl('turret/turret-crystal-repeater-v1.png'),
  ...
  'ui-menu-actions-atlas-v1': generatedAssetUrl('ui/ui-menu-actions-atlas-v1.png'),
  'ui-battle-hud-atlas-v1': generatedAssetUrl('ui/ui-battle-hud-atlas-v1.png'),
  'ui-summon-ritual-atlas-v1': generatedAssetUrl('ui/ui-summon-ritual-atlas-v1.png'),
  ...
  'skill-shell-triple-shock-icon': generatedAssetUrl('skill/skill-shell-triple-shock-icon.png'),
  'skill-crystal-rain-icon': generatedAssetUrl('skill/skill-crystal-rain-icon.png'),
  'skill-bubble-tide-domain-icon': generatedAssetUrl('skill/skill-bubble-tide-domain-icon.png'),
  'skill-sprout-forest-dance-icon': generatedAssetUrl('skill/skill-sprout-forest-dance-icon.png'),
  'skill-berry-chain-barrage-icon': generatedAssetUrl('skill/skill-berry-chain-barrage-icon.png'),
  'skill-dew-garland-icon': generatedAssetUrl('skill/skill-dew-garland-icon.png'),
  'skill-bell-sonic-ring-icon': generatedAssetUrl('skill/skill-bell-sonic-ring-icon.png'),
  'skill-drill-rupture-dash-icon': generatedAssetUrl('skill/skill-drill-rupture-dash-icon.png'),
  'skill-ember-scorch-line-icon': generatedAssetUrl('skill/skill-ember-scorch-line-icon.png'),
  'skill-ink-cone-burst-icon': generatedAssetUrl('skill/skill-ink-cone-burst-icon.png'),
  'skill-cloud-vortex-icon': generatedAssetUrl('skill/skill-cloud-vortex-icon.png'),
  'skill-frost-shard-lane-icon': generatedAssetUrl('skill/skill-frost-shard-lane-icon.png'),
  'skill-honey-cluster-icon': generatedAssetUrl('skill/skill-honey-cluster-icon.png'),
  'skill-spark-chain-arc-icon': generatedAssetUrl('skill/skill-spark-chain-arc-icon.png'),
  'skill-star-orbit-barrage-icon': generatedAssetUrl('skill/skill-star-orbit-barrage-icon.png'),
  ...
  'region-sunbud-sanctuary-field-a': generatedAssetUrl('region/region-sunbud-sanctuary-field-a.png'),
  ...
  'effect-projectile-berry-v1': generatedAssetUrl('effect/effect-projectile-berry-v1.png'),
  'effect-projectile-dew-v1': generatedAssetUrl('effect/effect-projectile-dew-v1.png'),
  'effect-projectile-bell-v1': generatedAssetUrl('effect/effect-projectile-bell-v1.png'),
  'effect-projectile-drill-v1': generatedAssetUrl('effect/effect-projectile-drill-v1.png'),
  'effect-projectile-ember-v1': generatedAssetUrl('effect/effect-projectile-ember-v1.png'),
  'effect-projectile-ink-v1': generatedAssetUrl('effect/effect-projectile-ink-v1.png'),
  'effect-projectile-cloud-v1': generatedAssetUrl('effect/effect-projectile-cloud-v1.png'),
  'effect-projectile-frost-v1': generatedAssetUrl('effect/effect-projectile-frost-v1.png'),
  'effect-projectile-honey-v1': generatedAssetUrl('effect/effect-projectile-honey-v1.png'),
  'effect-projectile-spark-v1': generatedAssetUrl('effect/effect-projectile-spark-v1.png'),
  'effect-projectile-star-v1': generatedAssetUrl('effect/effect-projectile-star-v1.png'),
  'effect-projectile-bean-bow-v1': generatedAssetUrl('effect/effect-projectile-bean-bow-v1.png'),
  'effect-projectile-leaf-spinner-v1': generatedAssetUrl('effect/effect-projectile-leaf-spinner-v1.png'),
  ...
  'effect-skill-crystal-laser-hit-v1': generatedAssetUrl('effect/effect-skill-crystal-laser-hit-v1.png'),
  'effect-skill-bubble-orb-v1': generatedAssetUrl('effect/effect-skill-bubble-orb-v1.png'),
  'effect-skill-bubble-burst-v1': generatedAssetUrl('effect/effect-skill-bubble-burst-v1.png'),
  'effect-skill-sprout-thorn-v1': generatedAssetUrl('effect/effect-skill-sprout-thorn-v1.png'),
  'effect-skill-berry-bomb-v1': generatedAssetUrl('effect/effect-skill-berry-bomb-v1.png'),
  'effect-skill-berry-burst-v1': generatedAssetUrl('effect/effect-skill-berry-burst-v1.png'),
  'effect-skill-dew-wave-crest-v1': generatedAssetUrl('effect/effect-skill-dew-wave-crest-v1.png'),
