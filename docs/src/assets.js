...
const DECLARED_ASSET_PATHS = {
  ...
  'terrain-soft-gel-node-a': generatedAssetUrl('terrain/terrain-soft-gel-node-a.png'),
  'terrain-dew-honey-node-a': generatedAssetUrl('terrain/terrain-dew-honey-node-a.png'),
  'terrain-crystal-shard-node-a': generatedAssetUrl('terrain/terrain-crystal-shard-node-a.png'),
  'terrain-thorn-thicket-a': generatedAssetUrl('terrain/terrain-thorn-thicket-a.png'),
  'terrain-brittle-boulder-a': generatedAssetUrl('terrain/terrain-brittle-boulder-a.png'),
  'terrain-deep-water-patch-a': generatedAssetUrl('terrain/terrain-deep-water-patch-a.png'),
  'terrain-ground-detail-a': generatedAssetUrl('terrain/terrain-ground-detail-a.png'),
