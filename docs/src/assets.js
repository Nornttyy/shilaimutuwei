...
export const ASSET_CACHE_VERSION = 'soft-gel-20260831-v13';
...
const DECLARED_ASSET_PATHS = {
  ...
  'effect-shell-triple-shock-frames-v1': generatedAssetUrl('effect/effect-shell-triple-shock-frames-v1.png'),
  'effect-crystal-rain-frames-v1': generatedAssetUrl('effect/effect-crystal-rain-frames-v1.png'),
  'effect-bubble-tide-domain-frames-v1': generatedAssetUrl('effect/effect-bubble-tide-domain-frames-v1.png'),
  'effect-sprout-forest-dance-frames-v1': generatedAssetUrl('effect/effect-sprout-forest-dance-frames-v1.png'),
  'effect-berry-chain-barrage-frames-v1': generatedAssetUrl('effect/effect-berry-chain-barrage-frames-v1.png'),
  'effect-dew-garland-frames-v1': generatedAssetUrl('effect/effect-dew-garland-frames-v1.png'),
