...
export const SHELL_CLIPS = deepFreeze(shellClips);
export const BUG_CLIPS = deepFreeze(bugClips);
...
const CRYSTAL_BONES = ['root', 'body', 'needles', 'face', 'front'];
const BUBBLE_BONES = ['root', 'body', 'bubbles', 'halo', 'face'];
const SPROUT_BONES = ['root', 'body', 'sprout', 'pack', 'face'];
const WINDCAP_BONES = ['root', 'stem', 'cap', 'face'];
const STONE_BONES = ['root', 'body', 'rocks', 'face'];
const BOSS_BONES = ['root', 'body', 'tentacles', 'crown', 'core', 'face'];
...
export const CRYSTAL_CLIPS = deepFreeze(crystalClips);
export const BUBBLE_CLIPS = deepFreeze(bubbleClips);
export const SPROUT_CLIPS = deepFreeze(sproutClips);
export const WINDCAP_CLIPS = deepFreeze(windcapClips);
export const STONE_CLIPS = deepFreeze(stoneClips);
export const BOSS_CLIPS = deepFreeze(bossClips);
